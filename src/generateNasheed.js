...
import jabArab from "./nasheeds/jab_arb.txt";
import jabEng from "./nasheeds/jab_eng.txt";
import jabRom from "./nasheeds/jab_rom.txt";
import rokArab from "./nasheeds/rok_arb.txt";
import rokEng from "./nasheeds/rok_eng.txt";
import rokRom from "./nasheeds/rok_rom.txt";
...
import khudiArab from "./nasheeds/khudi_arb.txt";
import khudiEng from "./nasheeds/khudi_eng.txt";
import khudiRom from "./nasheeds/khudi_rom.txt";
import jashneArab from "./nasheeds/jashn_arb.txt";
import jashneEng from "./nasheeds/jashn_eng.txt";
import jashneRom from "./nasheeds/jashn_rom.txt";
